...
anu =`
𝑺𝒆𝒍𝒂𝒎𝒂𝒕 𝒅𝒂𝒕𝒂𝒏𝒈 𝒅𝒊 BOTZ ツˣᴿᶻズガx 👋

❏ 𝑻𝒂𝒎𝒑𝒊𝒍𝒂𝒏 𝑴𝒆𝒏𝒖 BOTZ ツˣᴿᶻズガx ❏
𝑷𝒓𝒆𝒇𝒊𝒙 : 𝗠𝗨𝗟𝗧𝗜 & 𝗣𝗥𝗘𝗙𝗜𝗫
...
┃⬡${prefix}bear {teks}
└──────────────`
sendButImage(from, anu,`𝑺𝒆𝒍𝒂𝒎𝒂𝒕 𝑴𝒆𝒏𝒄𝒐𝑩𝒂 BOTZ ツˣᴿᶻズガx , 𝑭𝒊𝒕𝒖𝒓 𝑺𝒆𝒅𝒂𝒏𝒈 𝒅𝒂𝒍𝒂𝒎 𝑻𝒂𝒉𝒂𝒑 𝑷𝒆𝒏𝒈𝒆𝒎𝒃𝒂𝒏𝒈𝒂𝒏 𝑱𝒂𝒅𝒊 𝑱𝒊𝒌𝒂 𝑭𝒊𝒕𝒖𝒓 𝑬𝒓𝒐𝒓 𝑭𝒊𝒙 𝑺𝒆𝒏𝒅𝒊𝒓𝒊 𝒀𝒂 𝑭𝒓𝒆𝒆 𝑨𝒑𝒊𝒌𝒆𝒚 𝑪𝒓𝒆𝒂𝒕𝒐𝒓 𝑱𝒂𝒏𝒈𝒂𝒏 𝑫𝒊 𝑼𝒃𝒂𝒉 @𝑪𝒐𝒑𝒚𝑹𝒆𝒄 𝑩𝒚 ツˣᴿᶻズガx 𝑺𝒆𝒍𝒂𝒎𝒂𝒕 𝒎𝒆𝒏𝒄𝒐𝒃𝒂\n${Tanggal}`, thumb, [
...
case 'scrip':
if (isBanned) return reply(mess.banned)
reply2(`JANGAN LUPA SUBSCRIBE YouTube : https://youtu.be/cgaK-nGgvT8`)
break
//══════════[ ASUPAN MENU ]════════════════════════════//
             case 'asupangeayubi':
             if (isBanned) return reply(mess.banned)
